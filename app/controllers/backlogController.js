function backlogController($scope, $stateParams, $state, $controller, $timeout, toaster, storyService, sprintService) {
...
backlogController.$inject = [ '$scope', '$stateParams', '$state', '$controller', '$timeout', 'toaster', 'storyService', 'sprintService' ];
